...
public class J0914_11_쇼핑몰 {
	...
	//			System.out.println("아이디가 일치 : "+id);
	//			if(pw.equals(mm.getPw())) {
	//				System.out.println("패스워드 일치 :" +pw);
	//			}else {
	//				System.out.println("패스워드 불일치 : " +pw);
	//			}
	//		}else {
	//			System.out.println("아이디가 불일치 : "+id);
	//		}
			...
			programLoop:while(true) {
				...
				case 8:
					...
					for(int i=0; i<b1.list.size();i++) {
						Product p = (Product)b1.list.get(i);//list Object
						if(i==0) {
				...
				case 9:
					...
					b1.money += coin;
					System.out.println("-------------");
					System.out.println("충전 금액 : %,d원  \n"+coin);
					System.out.println("충전후 잔액 : %,d원  \n"+b1.money);
					System.out.println("------------");
					System.out.println();	
					break;
				case 0:
